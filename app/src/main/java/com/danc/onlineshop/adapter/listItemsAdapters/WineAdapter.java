...
public class WineAdapter extends RecyclerView.Adapter<WineAdapter.VodkaViewHolder> {
    ...
    public WineAdapter(Context context, final List<AlcoholItemModel> alcoholItemModels) {
